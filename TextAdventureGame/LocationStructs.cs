using System;namespace LocationStructs
{
    ...
    {
        public static Location Cave = new Location("You find yourself in a Cave.", 1, new Location[2], false, "Return");
        ...
        {
            Cave.GoTo = new Location[2]{HelpCame, BleedingCave};
            BleedingCave.GoTo = new Location[3]{OutsideOfCave,HelpCame, Cave};
            OutsideOfCave.GoTo = new Location[1]{OutsideOfCave};
